...
public class view_product extends AppCompatActivity {
    ...
    String url;
    ArrayList<String>p_name,p_price,p_image,p_quantity,p_description,id,avg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url ="http://"+sh.getString("ip", "") + ":5000/viewproduct";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    l1.setAdapter(new Custom_view_product(view_product.this,p_name,p_price,p_image,p_quantity,p_description,id,avg));
